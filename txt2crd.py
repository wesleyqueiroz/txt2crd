...
def runTests():
    ...
    """
    # Test simple chords and a chord that ends after the lyrics line
    line1 = "G                  Em              A\n"
    ...
    # Test more advanced chords and alternate bass note
    ...
    # Test simple line with no chords
    line1 = "Chorus:\n"
    line2 = "\n"
    actualLine = getChordProLines((line1, line2))
    expectedLine = line1 + "\n"
    ...
    # Test chord lines where no lyrics follow
    line1 = "solo:\n"
